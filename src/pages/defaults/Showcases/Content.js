          ...
          <Tab.Pane eventKey="second">
            <Container>
                ...
                <Col md={4} sm={12}>
                  <a href="LongGiang.html">
                    <div className="img-showcases-container">
                      <img
                        class="img img-showcases img-fluid"
                        alt="Showcases"
              ...
              <Row className="align-items-start row-margin-top-30 hide">
                <Col md={4} sm={12}>
                  <a href="LongGiang.html">
                    <div class="img-showcases-container items-margin-top-20">
                      <img
                        class="img img-showcases img-fluid"
                        alt="Showcases"
                      ...
                      <div class="overlay-showcases">
                        <div class="text-showcases">
                          <p class="montserrat-extrabold">Lễ ăn hỏi</p>
                          <h5 class="playfairdisplay-bolditalic">
                            Long & Giang
                          </h5>
                        </div>
                      </div>
